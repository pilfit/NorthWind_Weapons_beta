...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Howitzer203mm => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "203mmHowitzer",
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "howitzerrecoil",
                        AzimuthPartId = "None",
            ...
            {
                PartName = "203mm Howitzer", // name of weapon in terminal
                ...
                Graphics = new HardPointParticleDef {
                    ...
                    Effect1 = new ParticleDef {
                        Name = "203FiringParticle", // Smoke_LargeGunShot
            ...
            Animations = Howitzer203mm_Animation,
