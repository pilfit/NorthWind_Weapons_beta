...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef RailgunxturretM_Animation => new AnimationDef
        {
            ...
            Emissives = new []
            {
                  ...
                  Emissive(
                    ...
                    {
                        Color(red:255, green: 0, blue:0, alpha: 1f),//will transitions form one color to the next if more than one
                        Color(red:200f, green: 0f, blue: 0f, alpha: 1f),//will transitions form one color to the next if more than one
                        ...
                        [Firing] =
                            new[] //Firing, Reloading, Overheated, Tracking, On, Off, BurstReload, OutOfAmmo, PreFire define a new[] for each
                            {
                               ...
                               new RelMove
                                {
                                    CenterEmpty = "",
                                    TicksToMove = 9, //number of ticks to complete motion, 60 = 1 second
