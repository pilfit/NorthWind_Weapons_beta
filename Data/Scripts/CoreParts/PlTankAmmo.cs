...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef PlFXshots => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "PlFXshots",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                {
                    TracerMaterial = "WeaponLaser", // WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                    ColorVariance = Random(start: 0.1f, end: 1f), // multiply the color by random values within range.
        ...
        private AmmoDef PlFXshots2 => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "PlFXshots2",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 0f, // in kilograms
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 45f,
                        Width = 0.02f,
                        Color = Color(red: 40.0f, green: 35.20f, blue: 18.0f, alpha: 0.7f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
                        Material = "WeaponLaser",
                        DecayTime = 25,
                        Color = Color(red: 40.985f, green: 8.162f, blue: 4.81f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.3f,
                        UseWidthVariance = true,
                        UseColorFade = true,
