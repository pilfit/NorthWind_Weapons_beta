        ...
        WeaponDefinition C100mmTurret => new WeaponDefinition {
            ...
            HardPoint = new HardPointDef 
            {
                ...
                Loading = new LoadingDef {
                    ...
                    SkipBarrels = 0,
                    ReloadTime = 65, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    DelayUntilFire = 5, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
