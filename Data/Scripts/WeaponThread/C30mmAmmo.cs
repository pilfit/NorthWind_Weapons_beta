    ...
    partial class Weapons
    {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 0.1f,
                        Color = Color(red: 50.0f, green: 8.20f, blue: 0.5f, alpha: 1f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
                        ...
                        DecayTime = 2,
                        Color = Color(red: 18.985f, green: 6.162f, blue: 0.0f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.05f,
         ...
         private AmmoDef C30mmAmmoHE => new AmmoDef
        {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                DamageVoxels = false, // true = voxels are vulnerable to this weapon
                SelfDamage = false, // true = allow self damage.
                HealthHitModifier = 1.0, // defaults to a value of 1, this setting modifies how much Health is subtracted from a projectile per hit (1 = per hit).
                // modifier values: -1 = disabled (higher performance), 0 = no damage, 0.01 = 1% damage, 2 = 200% damage.
                VoxelHitModifier = 10,				
                Characters = -1f,
				FallOff = new FallOffDef
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 0.1f,
                        Color = Color(red: 50.0f, green: 50.0f, blue: 40.0f, alpha: 1f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
                        Material = "WeaponLaser",
                        DecayTime = 2,
                        Color = Color(red: 18.985f, green: 18.162f, blue: 5.0f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.05f,
                        UseWidthVariance = true,
                        UseColorFade = true,
