namespace WeaponThread
{
    partial class Weapons
    {
        internal Weapons()
        {
            ...
            ConfigFiles(RailgunxturretS, Railgunx75f, Railgunx150f, RailgunxturretM, Railgunx, Railgunxturretdeg, Railgunxturretb1, Railgunxturretb2, Railgunxturretb3, AMSlaser,
			Howitzer203mm);
        }
    }
}
