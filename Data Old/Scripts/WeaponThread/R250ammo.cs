...
{ // Don't edit above this line
    partial class Weapons
    {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 50f,
                        Width = 0.3f,
                        Color = Color(red: 70.80f, green: 35.20f, blue: 6.0f, alpha: 1f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
                        ...
                        DecayTime = 18,
                        Color = Color(red: 15.985f, green: 3.162f, blue: 0.21f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.4f,
        ...
        private AmmoDef railgunShrapnel3 => new AmmoDef
        {
		 ...
		 private AmmoDef R250ammoT => new AmmoDef
        {
            AmmoMagazine = "R250ammo",
            AmmoRound = "R250ammoT",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
